 ...
 * phase4TestA(), phase4TestB(), etc.  If you want to provide your own tests,
 * put them in methods named differently, such as the "doUserTests()" method
 * below. These will not be run from the GitHub classroom autotester, but can be
 * run as part of your development/testing.
 */

public class TesterCSC439P4 {
    /**
     * The testing engine. Compiles and runs input file using the RunCode class,
     * capturing standard output to compare with the expected output.
     * Non-matching (failed) tests could provide more useful output, but
     * for now this will have to do.
     *
     * @param testName the base name of the test case; files are stored
     *                 in the tests project directory, with ".in" and ".out"
     *                 extensions.
     */
